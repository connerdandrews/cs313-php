...
$statement->bindvalue(':last_name', $_SESSION["last_name"]);
$statement->bindvalue(':position_number', $SESSION["position_number"]);
$statement->bindvalue(':position', $SESSION["position"]);
$statement->execute();
